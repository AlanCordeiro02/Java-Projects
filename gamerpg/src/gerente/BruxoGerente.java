...
public class BruxoGerente {
	...
	public void getBruxoEstudante() {
		...
		criador.SetSinal1(new Ignis());
		criador.SetEquipamentoColar(new ColarPoder());
	}
	...
	public void getBruxoEmFormacao() {
		...
		criador.SetSinal1(new Lux());
		criador.SetEquipamentoColar(new ColarProtecao());
	}
	...
	public void getBruxoAltoNivel() {
		...
		criador.SetEquipamentoMaoDireita(new Espada(10, 5));
		criador.SetSinal1(new Praesidium());
		criador.SetSinal2(new Lux());
		criador.SetEquipamentoColar(new ColarRegeneracao());
	}
